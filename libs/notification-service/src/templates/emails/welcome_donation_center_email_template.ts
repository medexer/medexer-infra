export const welcome_donation_center_email_html_content = () => {
  return `
                ...
                <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                  <tr>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                      <tr>
                        <td align="center" style="padding:0;Margin:0;font-size:0"><img src="https://fryrscb.stripocdn.email/content/guids/CABINET_d49e5ef6a4040ed5e725092579bc91e753cbb8e9d44fb1d588f8ae45f8338933/images/aa.jpg" alt="" width="600" class="adapt-img" style="display:block;font-size:18px;border:0;outline:none;text-decoration:none"></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
                  ...
                  <tr>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                      <tr>
                        ...
                        <td align="center" bgcolor="#fefdfd" style="padding:0;Margin:0"><h1 style="Margin:0;font-family:Barlow, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:normal;line-height:55.2px;color:#1C3B4E"><strong>Welcome</strong></h1></td>
                      </tr>
                      <tr>
                        <td align="left" bgcolor="#fefdfd" class="es-m-p15r" style="Margin:0;padding-top:15px;padding-right:10px;padding-bottom:5px;padding-left:10px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Hello,<br><br>Thank you for joining Medexer. As a valued donation center in our network, you play a crucial role in saving lives by making blood readily available to those who need it most. <strong>Here's how Medexer supports your efforts:</strong></p></td>
                      </tr>
                      <tr>
                        ...
                        <ul style="font-family:Barlow, sans-serif;padding:0px 0px 0px 40px;margin-top:15px;margin-bottom:15px">
                          <li style="color:#1C3B4E;margin:0px 0px 15px;font-size:18px"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px;mso-margin-top-alt:15px">Connect with donors easily through our platform.</p></li>
                          <li style="color:#1C3B4E;margin:0px 0px 15px;font-size:18px"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Manage appointments and streamline donation schedules.</p></li>
                          <li style="color:#1C3B4E;margin:0px 0px 15px;font-size:18px"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Access donor history and health records to ensure safe and efficient collections.</p></li>
                          <li style="color:#1C3B4E;margin:0px 0px 15px;font-size:18px"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Receive updates and insights to improve your operations.</p></li>
                        </ul>
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Every drop counts, and your contribution could be the difference between life and death for someone in need. Together, we’re building a future where no one struggles to find the blood they need. Thank you for being a hero. Let’s make saving lives an inspiring journey – together.</p>
                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Warm regards,</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Team Medexer.</p></td>
                      </tr>
                    </table></td>
                  </tr>
