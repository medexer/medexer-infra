                  ...
                  <tr>
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                      <tr>
                        ...
                        <td align="center" bgcolor="#fefdfd" style="padding:0;Margin:0"><h1 style="Margin:0;font-family:Barlow, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:normal;line-height:55.2px;color:#1C3B4E"><strong>Email Verification</strong></h1></td>
                      </tr>
                      <tr>
                        <td align="left" bgcolor="#fefdfd" class="es-m-p15r" style="Margin:0;padding-top:15px;padding-right:10px;padding-bottom:5px;padding-left:10px">
                          <p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Hello ${donor},<br><br>Thank you for signing up with Medexer! To complete your registration, we need to verify your email address.</p>
                        </td>
                      </tr>
                       <tr>
                        <td align="left" bgcolor="#fefdfd" class="es-m-p15r" style="Margin:0;padding-top:15px;padding-right:10px;padding-bottom:5px;padding-left:10px">
                          <p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Here is your verification code (OTP):</p>
                          </br>
                          ...
                          <p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">This code is valid for the next 1 hour. Please enter it on the verification page to confirm your email address.</p>
                           </br>
