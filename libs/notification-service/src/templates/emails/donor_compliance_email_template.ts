export const donor_compliance_email_html_content = (donor: string)=>{
    return `
                ...
                <tr>
                  ...
                  <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                    <tr>
                      ...
                      <td align="center" bgcolor="#fefdfd" style="padding:0;Margin:0"><h1 style="Margin:0;font-family:Barlow, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:normal;line-height:55.2px;color:#1C3B4E"><strong>KYC Compliance</strong></h1></td>
                    </tr>
                    <tr>
                      <td align="left" bgcolor="#fefdfd" class="es-m-p15r" style="Margin:0;padding-top:15px;padding-right:10px;padding-bottom:5px;padding-left:10px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Hello ${donor},<br><br>Your compliance has been successfully uploaded, and you can now access the Medexer platform. <strong>Here’s what you can do:</strong></p></td>
                    </tr>
                    <tr>
                      ...
                      <ul style="font-family:Barlow, sans-serif;padding:0px 0px 0px 40px;margin-top:15px;margin-bottom:15px">
                        <li style="color:#1C3B4E;margin:0px 0px 15px;font-size:18px"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px;mso-margin-top-alt:15px">Find nearby donation centers.</p></li>
                        <li style="color:#1C3B4E;margin:0px 0px 15px;font-size:18px"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Schedule convenient appointments.</p></li>
                        <li style="color:#1C3B4E;margin:0px 0px 15px;font-size:18px"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Track your donation history.</p></li>
                        <li style="color:#1C3B4E;margin:0px 0px 15px;font-size:18px"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Enjoy free health blood tests.</p></li>
                      </ul><p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Your contribution saves lives. Let’s build a future where no one struggles to find blood. Thank you for being part of Medexer!
