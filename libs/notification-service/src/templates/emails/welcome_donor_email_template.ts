export const welcome_donor_email_html_content = (donor: string) => {
  return `
                  ...
                  <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                    ...
                    <tr>
                      ...
                      <ul style="font-family:Barlow, sans-serif;padding:0px 0px 0px 40px;margin-top:15px;margin-bottom:15px">
                        <li style="color:#1C3B4E;margin:0px 0px 15px;font-size:18px"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px;mso-margin-top-alt:15px">Discover donation centers near you – no more guesswork, just convenience.</p></li>
                        <li style="color:#1C3B4E;margin:0px 0px 15px;font-size:18px"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Schedule appointments that fit into your busy life.</p></li>
                        <li style="color:#1C3B4E;margin:0px 0px 15px;font-size:18px"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Track your donation history and celebrate your life-saving milestones.</p></li>
                        <li style="color:#1C3B4E;margin:0px 0px 15px;font-size:18px"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Enjoy free blood tests to help manage your health.</p></li>
                      </ul><p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Every drop counts, Kunle, and your contribution could be the difference between life and death for someone in need. Together, we’re building a future where no one struggles to find the blood they need. Thank you for being a hero. Let’s make saving lives an inspiring journey – together.</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Warm regards,</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:Barlow, sans-serif;line-height:27px;letter-spacing:0;color:#1C3B4E;font-size:18px">Team Medexer.</p></td>
                    </tr>
                  </table></td>
                </tr>
              </table></td>
